...
plots = [
    ...
    imread(script_path + 'la_' + dataset +'_2_key_points.png'),
    imread(script_path + 'la_' + dataset +'_5_key_points.png'),
    imread(script_path + 'gpt_' + dataset + '_2_keypoints.png'),
    imread(script_path + 'gpt_' + dataset +'.png'),

    imread(script_path + 'la_' + odd +'_2_key_points.png'),
    imread(script_path + 'la_' + odd +'_5_key_points.png'),
    imread(script_path + 'gpt_' + odd + '_2_keypoints.png'),
    imread(script_path + 'gpt_' + odd +'.png'),
...
# Save the figure
fig.savefig(script_path + 'gpt_vs_le_comparison.pdf', dpi=300, bbox_inches='tight')
# plt.show()