...
method = GPR(C(constant_value=10) * RBF(1*np.ones(2), [0.1,10]) + WhiteKernel(0.01))
...
plt.savefig(source_path+'/pictures/space_deformation.png', dpi=300, bbox_inches='tight')
plt.show()
